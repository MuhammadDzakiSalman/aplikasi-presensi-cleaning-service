...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col d-flex justify-content-center">
                                    ...
                                    <button class="btn btn-secondary" id="retry" style="display:none;" type="button">Ulangi</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Fungsi untuk meminta izin kamera dan lokasi saat halaman pertama kali dimuat
        window.onload = function() {
            requestPermissions();
        };

        // Fungsi untuk meminta izin akses kamera dan lokasi
        ...
        async function startCamera() {
            try {
                ...
                // Sembunyikan tombol dan tampilkan tombol ambil foto setelah kamera aktif
        ...
        // Fungsi untuk mengirimkan data presensi
        submitButton.addEventListener('click', async function() {
            ...
            try {
                ...
                const response = await fetch('/presensi/out', {
                    method: 'POST',
                    headers: {
